package com.koolew.android.camerapreview.opengl.filter;

/**
 * Created by wangyang on 15/7/23.
 */
public class FrameRendererEmboss extends FrameRendererDrawOrigin {
    ...
    public static FrameRendererEmboss create(boolean isExternalOES) {
        FrameRendererEmboss renderer = new FrameRendererEmboss();
